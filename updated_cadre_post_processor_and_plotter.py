...
def get_data(db_file_name):
    ...
    cds = CaseDataset(db_file_name, 'json')
    data = cds.data.fetch()
    n_cases = len(data ) # not really correct
...
if __name__ == "__main__": 
    ...
    n_cases_prune, data_prune = get_data('unconstrained.json')
    print n_cases_prune, data_prune
